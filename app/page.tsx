...
const TICKER_ITEMS = [
  'AI Approved ✓', 'Chad Certified', 'Not Affiliated With OpenAI',
  'Wear Your Opinions Loudly', 'GPT-4 Tested', '0% Hallucinations',
  'Ships Faster Than AI Roadmaps', 'Human Approved', 'No GPUs Were Harmed',
  'Ethically Questionable Fashion', 'Prompt-Engineered Style',
];
...
export default function Home() {
  ...
  const marqueeText = 'Free shipping on orders over $60 \u00a0·\u00a0 Not affiliated with OpenAI. Not even a little. \u00a0·\u00a0 New drops every season 🔥 \u00a0·\u00a0 AI-adjacent fashion since 2024 \u00a0·\u00a0 No hallucinations in our cotton blend \u00a0·\u00a0 ';

  return (
    <>
      {/* ANNOUNCEMENT MARQUEE */}
      <div className="announce-bar" aria-label="Announcements">
